...
const INITIAL_PROJECT: ProjectDetail = {
  ...
  techStack: [
    { name: "React 18", colorClass: "bg-[#e2f5f9] text-[#0a6cb9]" },
    { name: "TypeScript", colorClass: "bg-[#f3e8ff] text-[#662d91]" },
    { name: "TailwindCSS", colorClass: "bg-[#e0f8f5] text-[#20bec6]" },
    { name: "Node.js", colorClass: "bg-[#fdf2f8] text-[#ec008c]" },
    { name: "PostgreSQL", colorClass: "bg-[#fffbeb] text-[#f7901e]" },
  ],
  metrics: {
    talentMatch: 94,
    activeApplicants: 18,
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-secondary via-secondary/95 to-primary p-6 text-white shadow-[var(--shadow-soft)] md:p-10">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          <div className="flex shrink-0 gap-3">
            ...
            <Button
              variant="secondary"
              className="bg-[#0e4884] text-white hover:bg-[#0e4884]/90 border-transparent shadow-none"
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="h-1.5 w-full rounded-full bg-surface-sunken">
                    <div
                      className="h-1.5 rounded-full bg-[#0e4884] transition-all duration-500"
