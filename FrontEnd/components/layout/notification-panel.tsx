        ...
        <button
          ...
          className={cn(
            ...
            dark
              ...
              : "text-ink-muted hover:bg-surface-sunken dark:text-white/70 dark:hover:bg-white/10 dark:hover:text-white",
          )}
        >
          ...
          {unread > 0 && (
            <span
              ...
              className={cn(
                ...
                "bg-highlight text-ink-strong dark:text-secondary",
              )}
            >
              {unread > 9 ? "9+" : unread}
            </span>
